...
activity, health, config application, and signed updates. Hosted-only modules additionally
...
- Separate protocol, auth, terminal, history, process, upload, preview, activity, config,
...
- An open PTY, process, or socket is not activity. Silent Herdr work needs a trusted
  signal.
